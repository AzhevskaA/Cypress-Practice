...
it ('go to jobs page and make sure jobs id 100 appear', () =>{
    ...
    cy.get('.jobs-module__quickJob___3NbDw').contains('100').should('have.text', '100');
...
it ('create a new lead', () =>{
    ...
    leadPage.fillInPhone(leadPhoneNumber);
    leadPage.fillInClinet(leadClientName);
    leadPage.clickCreate();
